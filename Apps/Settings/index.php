...
var game = "80";
  ...
  <script type="text/javascript">
    google.load('visualization', '1.5', {packages: ['line']});
    google.setOnLoadCallback(drawChart);
...
.modal23  {
z-index: 1003; display: none; opacity: 1; transform: scaleX(1); top: 10%; position:relative;
}
        paper-tabs  {
        background: transparent;
        ...
        <li class="middle dragend-page">
          ...
          <div id="modal2" class="modal modal-fixed-footer modal23">
            ...
            <div class="modal-footer">
              <button id="modal2_coniform" href="#!" class="buttu modal-action ">OK       <paper-ripple>
              <div id="background" class="style-scope paper-ripple" style="opacity: 0.00279999999329447;"></div>
              <div id="waves" class="style-scope paper-ripple"></div>
            </paper-ripple></button>
              <button id="modal2_coniform" href="#!" class="buttu modal-action ">Cancel       <paper-ripple>
              <div id="background" class="style-scope paper-ripple" style="opacity: 0.00279999999329447;"></div>
              <div id="waves" class="style-scope paper-ripple"></div>
            </paper-ripple></button>
            </div>
