...
<hg></hg>
        ...
        <li class="middle dragend-page">
          ...
          <div id="modal2" class="modal modal-fixed-footer" style="z-index: 1003; display: none; opacity: 1; transform: scaleX(1); top: 10%;position:relative;">
    ...
    <script>
      ...
      function myFunction(response) {
        ...
        for (i = 0; i < arr.length; i++) {
          ...
          out += "<img id=\"" + arr[i].Name + "\"" + " src=\"" + arr[i].Icon + "\"" + " width=\"60px\"" + "><h1>" + arr[i].Name + "</h1>";
