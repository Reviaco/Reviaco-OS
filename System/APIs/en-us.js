...
(function ($) {
    ...
    function setFontColor(elementName, color) {
        if (color == 'black') {
    ...
    $.fn.text0 = function (options) {
        ...
        return this.each(function () {
            ...
            if (settings.color) {
                setFontColor(name, settings.color);
            }
    ...
    $.fn.button = function (options) {
        ...
        return this.each(function () {
            ...
            if (settings.fontColor) {
                setFontColor(name, settings.fontColor);
            }
            if (settings.fontStyle) {
                $('#' + name + '').css('font-style', settings.fontStyle);
            }
            if (settings.disabled == 'yup') {
                $('#' + name + '').attr('disabled', '');
            }
            if (settings.raised == 'yup') {
                $('#' + name + '').attr('raised', '');
            }
            if (settings.switchedOn == 'yup') {
                $('#' + name + '').attr('toggles', '');
            }
            if (settings.thickness) {
                if (settings.thickness == 'thick') {
    ...
    $.fn.icon = function (options) {
        ...
        return this.each(function () {
            ...
            if (settings.iconColor) {
                if (settings.iconColor == 'black') {
                    $('#' + name + '').css('color', '#000000');
                } else if (settings.iconColor == 'red') {
                    $('#' + name + '').css('color', '#F44336');
                } else if (settings.iconColor == 'blue') {
                    $('#' + name + '').css('color', '#2196F3');
                } else if (settings.iconColor == 'cyan') {
                    $('#' + name + '').css('color', '#00BCD4');
                } else if (settings.iconColor == 'gray') {
                    $('#' + name + '').css('color', '#9E9E9E');
                } else if (settings.iconColor == 'green') {
                    $('#' + name + '').css('color', '#4CAF50');
                } else if (settings.iconColor == 'white') {
                    $('#' + name + '').css('color', '#FFFFFF');
                } else if (settings.iconColor == 'orange') {
                    $('#' + name + '').css('color', '#FF9800');
                } else if (settings.iconColor == 'yellow') {
                    $('#' + name + '').css('color', '#FFEB3B');
                } else if (settings.iconColor == 'brown') {
                    $('#' + name + '').css('color', '#795548');
                } else if (settings.iconColor == 'teal') {
                    $('#' + name + '').css('color', '#009688');
                } else if (settings.iconColor == 'pink') {
                    $('#' + name + '').css('color', '#E91E63');
                } else if (settings.iconColor == 'lightGreen') {
                    $('#' + name + '').css('color', '#8BC34A');
                } else {
                    $('#' + name + '').css('color', settings.iconColor);
                }
            }
            if (settings.size) {
                $('#' + name + '').css('font-size', settings.size);
    ...
    $.fn.colorsPalette = function (options) {
        // Establish our default settings
        var settings = $.extend({
            name: null,
            width: null,
