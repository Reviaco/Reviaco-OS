...
Navigate to `https://reviaco.os:9876/debug.html` to open the test runner in your
...
Example: `https://reviaco.os:9876/base/test/web-platform-tests/web-animations/animation/pause.html`
