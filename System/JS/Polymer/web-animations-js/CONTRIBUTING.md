...
Navigate to `https://localhost:9876/debug.html` to open the test runner in your
...
Example: `https://localhost:9876/base/test/web-platform-tests/web-animations/animation/pause.html`
