...
document.getElementById('app_promo_cube_6_A').style.backgroundImage = 'url("https://github.com/Reviaco/Echo-Store/raw/master/Apps/' + info[0].app_promo_cube_6_A_type + '/' + info[0].app_promo_cube_6_A_name + '/cover.jpg")';
