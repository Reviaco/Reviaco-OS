...
<body>
      ...
      <div class="content">
         ...
         <paper-card id="" class="card" heading="Language and input">
            <div class="card-content">Are you an alien ?!!
               No problem, your language is supported.....:)
            </div>
         </paper-card>
   ...
   <section id="Users_settings_sub" class="Users_settings_sub">
      <div id="users_listbox_sub" role="listbox">
         <h4></h4>
         <paper-icon-item onclick='' id="deletition">
            <div class="avatar blue" item-icon></div>
            <paper-item-body two-line>
               <div>Delete Account</div>
               <div id="description" secondary></div>
            </paper-item-body>
   ...
   <section id="Apps_settings" class="Apps_settings">
      <div id="apps_listbox" role="listbox">
      </div>
   </section>
   <section id="About_settings" class="About_settings">
      <div id="about_listbox" role="listbox">
         <paper-icon-item onclick='' id="version_container">
            <div class="avatar blue" item-icon></div>
            <paper-item-body two-line>
               <div>Version</div>
               <div id="version" secondary></div>
            </paper-item-body>
         </paper-icon-item>
         <paper-icon-item onclick='' id="build_date_container">
            <div class="avatar blue" item-icon></div>
            <paper-item-body two-line>
               <div>Build Date</div>
               <div id="build_date" secondary></div>
            </paper-item-body>
         </paper-icon-item>
      </div>
   </section>
   <section id="Sound_settings" class="Sound_settings">
      <div id="sound_listbox" role="listbox">
         <paper-icon-item onclick='' id="volume_btn_container">
            <div class="avatar blue" item-icon></div>
            <paper-item-body two-line>
               <div>Sound Volumes</div>
               <div id="volume_tip" secondary>Loud sounds cause DEATH ;)</div>
            </paper-item-body>
         </paper-icon-item>
         <paper-icon-item onclick='' id="ringtone_btn_container">
            <div class="avatar blue" item-icon></div>
            <paper-item-body two-line>
               <div>Ringtone</div>
               <div id="ringtone_tip" secondary>Keep yourself happy with out daily updated HD ringtones</div>
            </paper-item-body>
         </paper-icon-item>
      </div>
   </section>
